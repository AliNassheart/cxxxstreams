...
ALTER TYPE public.stream_status OWNER TO streamhub;
...
ALTER TYPE public.user_role OWNER TO streamhub;
...
ALTER TABLE public.chat_messages OWNER TO streamhub;
...
ALTER TABLE public.streams OWNER TO streamhub;
...
ALTER TABLE public.users OWNER TO streamhub;
